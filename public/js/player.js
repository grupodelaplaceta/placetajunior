...
function abrirJuego(act) {
  ...
  if (esCode) {
    ...
    bloquesJuego.forEach((b, bi) => {
      ...
      } else if (['arrastrar','buscar','detective','laboratorio','construccion','presupuesto','exploracion','simulacion','historia_interactiva','memoria','sonido','codigo_secreto','escape_room'].includes(b.tipo) && b.datos) {
